# FlowOS — novi detaljan plan realizacije

**Datum:** 31. juli 2026.  
**Status:** Operativni plan za početak implementacije  
...
8. šta korisnik treba odlučiti.

Prva korisna verzija obuhvata faze 0–4. Managed Execution, durable poslovi i multiagent verifier dolaze tek nakon što je osnovni wrapper svakodnevno korišten.
...
```text
id, session_id, agent_job_id nullable,
...
Prikazati stvaran projekat i zadatak u topbaru.
...
3. pokreni `git status --short`;
4. utvrdi postoji li tuđi WIP;
5. potvrdi ili odbaci radnu hipotezu dokazom;
6. uradi impact analizu;
7. klasifikuj rizik;
8. za HIGH/CRITICAL napravi project room i čekaj potvrdu;
9. za dugotrajan ili paralelan rad koristi zaseban worktree;
10. napiši 2–4 rečenice šta si razumio i šta planiraš.
...
6. navedi šta nije provjereno;
7. za HIGH/CRITICAL obezbijedi nezavisnog checkera;
8. ne počinji sljedeći task bez korisničke potvrde ako task mijenja arhitekturu ili scope plana.
...
9. koju odluku korisnik sada treba donijeti.
